...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_Camera p_Camera;
        ...
        public static SteamVR_Input_ActionSet_Camera Camera
        {
            get
            {
                return SteamVR_Actions.p_Camera.GetCopy<SteamVR_Input_ActionSet_Camera>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_Camera = ((SteamVR_Input_ActionSet_Camera)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_Camera>("/actions/Camera")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.Camera};
        }
    }
}
