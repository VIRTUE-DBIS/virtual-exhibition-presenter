...
namespace Unibas.DBIS.VREP.UI
{
    ...
    /// </summary>
    public class InWorldSteamVRButton : MonoBehaviour
    {
        [Serializable]
        ...
        public WorldButtonHandler Handler;


        public static InWorldSteamVRButton Create(GameObject parent, Vector3 position, WorldButtonHandler handler,
            ButtonModel model, string text, string name = "InWorldButton")
        {
            var go = new GameObject(name);
            InWorldSteamVRButton btn = go.AddComponent<InWorldSteamVRButton>();
        ...
        public static InWorldSteamVRButton Create(GameObject parent, Vector3 position, WorldButtonHandler handler,
            ButtonModel model, Sprite image, string name = "InWorldButton")
        {
            var go = new GameObject(name);
            InWorldSteamVRButton btn = go.AddComponent<InWorldSteamVRButton>();
            btn.transform.SetParent(parent.transform, false);
        ...
        /*
         // TODO Actually accept the UI prefab as parameter
        public static InWorldSteamVRButton Create(GameObject parent, Vector3 position, WorldButtonHandler handler,
            ButtonModel model, string name = "InWorldButton")
        {
            var go = new GameObject(name);
            InWorldSteamVRButton btn = go.AddComponent<InWorldSteamVRButton>();
            btn.transform.SetParent(parent.transform, false);
        ...
        public interface WorldButtonHandler
        {
            /// <summary>
            /// Gets called when the associated world button is pressed
            /// </summary>
            void OnButtonPres(InWorldSteamVRButton button);
        }
