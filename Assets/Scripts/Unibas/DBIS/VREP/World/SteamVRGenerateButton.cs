...
{
  public class SteamVRGenerateButton : MonoBehaviour
  {
    [Serializable]
    public class GenerateButtonModel
    {
      ...
      public GenerateButtonModel(float size, float border, float height, Material pedestalMaterial,
    ...
    public static SteamVRGenerateButton Create(GameObject parent, Vector3 position, Vector3 destination,
      GenerateButtonModel model, Sprite image)
    {
